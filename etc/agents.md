...
Always consulting local documentation for current Rust dependencies. Local
documentation is guaranteed to be up-to-date, and always documents the version
of dependency that is actually in use.
